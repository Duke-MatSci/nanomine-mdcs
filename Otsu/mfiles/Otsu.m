...
Body3 = ['The binarization process is complete and you can view the results','<a href= http://nanomine.northwestern.edu:8001/Otsu_view_Result.html?foo=',num2str(Job_ID),'&submit=Send> here</a></p>'];
...
fileID = fopen('/home/NANOMINE/Develop/mdcs/Otsu/email.html','wt+');
fprintf(fileID,'%s\n',To);
fprintf(fileID,'%s\n',Subject);
fprintf(fileID,'%s\n',Content);
fprintf(fileID,'%s\n',html_headers);
