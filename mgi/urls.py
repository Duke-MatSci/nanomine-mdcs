...
urlpatterns = patterns('',
    ...
    url(r'^descchar/', 'descchar.views.Descriptor_Placeholder',name='descchar'),
    url(r'^descchar_view$', 'descchar.views.check', name='descchar-check'),
    url(r'^niblack/', 'niblack.views.Niblack_Placeholder',name='niblack'),
    url(r'^niblack_view$', 'niblack.views.check', name='niblack-check'),    
    ...
    url(r'^RECON/', 'RECON.views.Descriptor_Placeholder', name='RECON'),
