...
class XMLdata():
    ...
    def executeQuery(query):
        ...
        xmldata = db['xmldata']
        # query mongo db
        cursor = xmldata.find(query) #/* pymongo 3.0 removed - , as_class=OrderedDict*/)
    ...
    def update_publish(postID):
        ...
        # get the xmldata collection
        xmldata = db['xmldata']
        xmldata.update({'_id': ObjectId(postID)},
                       {'$set': {'publicationdate': datetime.datetime.now(), 'ispublished': True}}, upsert=False)
